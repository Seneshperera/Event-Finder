    ...
    >
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-neutral-900">Register as Event Organizer</h1>
          <p className="text-neutral-600 mt-2">Join our platform to showcase your events</p>
        </div>
